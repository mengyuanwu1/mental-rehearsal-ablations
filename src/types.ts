...
export type TrialResponse = {
  ...
  choice: "left" | "right";
  leftBodyStateRating: number;
  rightBodyStateRating: number;
  leftTaskGoalRating: number;
  rightTaskGoalRating: number;
  leftValueConnectionRating: number;
  rightValueConnectionRating: number;
  leftEaseRating: number;
  rightEaseRating: number;
  leftRating: number;
  rightRating: number;
  improvement: string;
